...
export interface IGetListCallParams extends IPaginationParams, ISortParams, ICallDateFilter, Partial<Pick<ICall, 'deviceId' | 'contactName' | 'direction' | 'phoneNumber'>> {
}
